...
1. my name is jack
2. i am jack
3. How should I deal with this subject hand?
[keywords]
my name is | i am | hand
    """
    ...
    WebsocketReq1 = WebsocketReq(
        ...
        audio_file=r'C:\Users\14348\Desktop\head.wav',
        text=reftext,
        category='simple_expression',
        ent='en_vip')
